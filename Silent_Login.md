...
2. You need to make an agreement with Mercuryo about Mercuryo's rights to use personal data for registration and transfer to third parties.
3. You need to ask users to accept the Mercuryo term in your interface.
4. Contact your account manager for negotiation about what user data is allowed for silent sign-up for your users. 

## 3. API methods
There are two API methods: one for users that already have mercuryo account and one for new ones.

### 1. **Silent Login**

Use `/sdk-partner/login` for users already registered in Mercuryo:
